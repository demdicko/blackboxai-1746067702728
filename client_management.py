...
class ClientManagement(tk.Toplevel):
    ...
    def create_widgets(self):
        ...
        tk.Label(form_frame, text="Contact Number:").grid(row=1, column=0, sticky=tk.W, padx=5, pady=5)
        ...
        self.add_btn = tk.Button(btn_frame, text="Add Client", command=self.add_client)
        self.add_btn.pack(side=tk.LEFT, padx=5)

        self.update_btn = tk.Button(btn_frame, text="Update Client", command=self.update_client, state=tk.DISABLED)
        self.update_btn.pack(side=tk.LEFT, padx=5)

        self.delete_btn = tk.Button(btn_frame, text="Delete Client", command=self.delete_client, state=tk.DISABLED)
        ...
        self.tree.heading("Credit Balance", text="Credit Balance")
